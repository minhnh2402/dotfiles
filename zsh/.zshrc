...
# Export PATH to include local bin directories
export PATH=/home/minhnguyen/tools/arm-gnu-toolchain-13.2.Rel1-x86_64-arm-none-eabi/bin/:$PATH
...
zle -N fzf-history
bindkey '^r' fzf-history    # Ctrl+R fuzzy search history
