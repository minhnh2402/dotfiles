...
local config = wezterm.config_builder()  -- safer than plain table, gives better errors
local io = require("io")
local os = require("os")

local brightness = 0.03  -- very dark overlay, good for readability
...
config.window_background_image_hsb = {
    brightness = brightness,  -- 0.03 = very dark (3% brightness)
    hue = 1.0,                -- no hue shift
    saturation = 0.8,         -- slightly desaturated
}

local bg_image = home .. "/.config/wezterm/bg/nier-automata-2B-dark-desktop-wallpaper-preview.jpg"
